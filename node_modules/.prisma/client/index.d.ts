...
export namespace Prisma {
  ...
  */
  ...
  export type PostCountOutputTypeGetPayload<S extends boolean | null | undefined | PostCountOutputTypeArgs, U = keyof S> =
    S extends { select: any, include: any } ? 'Please either choose `select` or `include`' :
  ...
  export type FriendshipCountOutputTypeGetPayload<S extends boolean | null | undefined | FriendshipCountOutputTypeArgs, U = keyof S> =
    S extends { select: any, include: any } ? 'Please either choose `select` or `include`' :
  ...
  export type ConversationMessageCountOutputTypeGetPayload<S extends boolean | null | undefined | ConversationMessageCountOutputTypeArgs, U = keyof S> =
    S extends { select: any, include: any } ? 'Please either choose `select` or `include`' :
  ...
  export type UserGetPayload<S extends boolean | null | undefined | UserArgs, U = keyof S> =
    ...
    [P in TrueKeys<S['include']>]:
        ...
        P extends 'postLikes' ? Array < PostLikeGetPayload<Exclude<S['include'], undefined | null>[P]>>  :
        P extends 'postComment' ? Array < PostCommentGetPayload<Exclude<S['include'], undefined | null>[P]>>  :
        P extends 'fromFriendship' ? Array < FriendshipGetPayload<Exclude<S['include'], undefined | null>[P]>>  :
        P extends 'toFrienship' ? Array < FriendshipGetPayload<Exclude<S['include'], undefined | null>[P]>>  :
        P extends 'blockedUsers' ? Array < UserGetPayload<Exclude<S['include'], undefined | null>[P]>>  :
        P extends 'blockedByUsers' ? Array < UserGetPayload<Exclude<S['include'], undefined | null>[P]>>  :
        P extends 'conversationsSent' ? Array < ConversationGetPayload<Exclude<S['include'], undefined | null>[P]>>  :
        P extends 'conversationsReceived' ? Array < ConversationGetPayload<Exclude<S['include'], undefined | null>[P]>>  :
        P extends 'conversationMessages' ? Array < ConversationMessageGetPayload<Exclude<S['include'], undefined | null>[P]>>  :
    ...
    [P in TrueKeys<S['select']>]:
        ...
        P extends 'postLikes' ? Array < PostLikeGetPayload<Exclude<S['select'], undefined | null>[P]>>  :
        P extends 'postComment' ? Array < PostCommentGetPayload<Exclude<S['select'], undefined | null>[P]>>  :
        P extends 'fromFriendship' ? Array < FriendshipGetPayload<Exclude<S['select'], undefined | null>[P]>>  :
        P extends 'toFrienship' ? Array < FriendshipGetPayload<Exclude<S['select'], undefined | null>[P]>>  :
        P extends 'blockedUsers' ? Array < UserGetPayload<Exclude<S['select'], undefined | null>[P]>>  :
        P extends 'blockedByUsers' ? Array < UserGetPayload<Exclude<S['select'], undefined | null>[P]>>  :
        P extends 'conversationsSent' ? Array < ConversationGetPayload<Exclude<S['select'], undefined | null>[P]>>  :
        P extends 'conversationsReceived' ? Array < ConversationGetPayload<Exclude<S['select'], undefined | null>[P]>>  :
        P extends 'conversationMessages' ? Array < ConversationMessageGetPayload<Exclude<S['select'], undefined | null>[P]>>  :
  ...
  export type PostSelect = {
    ...
    postAttachments?: boolean | PostAttachmentFindManyArgs
  ...
  export type PostGetPayload<S extends boolean | null | undefined | PostArgs, U = keyof S> =
    ...
    [P in TrueKeys<S['include']>]:
        ...
        P extends 'postLikes' ? Array < PostLikeGetPayload<Exclude<S['include'], undefined | null>[P]>>  :
        P extends 'postComments' ? Array < PostCommentGetPayload<Exclude<S['include'], undefined | null>[P]>>  :
        P extends 'postAttachments' ? Array < PostAttachmentGetPayload<Exclude<S['include'], undefined | null>[P]>>  :
    ...
    [P in TrueKeys<S['select']>]:
        ...
        P extends 'postLikes' ? Array < PostLikeGetPayload<Exclude<S['select'], undefined | null>[P]>>  :
        P extends 'postComments' ? Array < PostCommentGetPayload<Exclude<S['select'], undefined | null>[P]>>  :
        P extends 'postAttachments' ? Array < PostAttachmentGetPayload<Exclude<S['select'], undefined | null>[P]>>  :
  ...
  export class Prisma__PostClient<T, Null = never> implements PrismaPromise<T> {
    ...
    postAttachments<T extends PostAttachmentFindManyArgs= {}>(args?: Subset<T, PostAttachmentFindManyArgs>): PrismaPromise<Array<PostAttachmentGetPayload<T>>| Null>;
  ...
  export type PostLikeGetPayload<S extends boolean | null | undefined | PostLikeArgs, U = keyof S> =
    S extends { select: any, include: any } ? 'Please either choose `select` or `include`' :
    ...
    [P in TrueKeys<S['select']>]:
        P extends 'user' ? UserGetPayload<Exclude<S['select'], undefined | null>[P]> :
        P extends 'post' ? PostGetPayload<Exclude<S['select'], undefined | null>[P]> :  P extends keyof PostLike ? PostLike[P] : never
  } 
      : PostLike
  ...
  export interface PostLikeDelegate<GlobalRejectSettings extends Prisma.RejectOnNotFound | Prisma.RejectPerOperation | false | undefined> {
    ...
    **/
    ...
    /**
     * Find one PostLike that matches the filter or throw
     * `NotFoundError` if no matches were found.
   ...
   */
  export type PostLikeFindUniqueOrThrowArgs = PostLikeFindUniqueArgsBase
      

  /**
   * PostLike: findFirstOrThrow
   */
  export type PostLikeFindFirstOrThrowArgs = PostLikeFindFirstArgsBase
  ...
  export type PostCommentGetPayload<S extends boolean | null | undefined | PostCommentArgs, U = keyof S> =
    S extends { select: any, include: any } ? 'Please either choose `select` or `include`' :
    ...
    [P in TrueKeys<S['select']>]:
        P extends 'user' ? UserGetPayload<Exclude<S['select'], undefined | null>[P]> :
        P extends 'post' ? PostGetPayload<Exclude<S['select'], undefined | null>[P]> :  P extends keyof PostComment ? PostComment[P] : never
  } 
      : PostComment
  ...
  export interface PostCommentDelegate<GlobalRejectSettings extends Prisma.RejectOnNotFound | Prisma.RejectPerOperation | false | undefined> {
    ...
    **/
    ...
    /**
     * Find one PostComment that matches the filter or throw
     * `NotFoundError` if no matches were found.
   ...
   */
  export type PostCommentFindUniqueOrThrowArgs = PostCommentFindUniqueArgsBase
      

  /**
   * PostComment: findFirstOrThrow
   */
  export type PostCommentFindFirstOrThrowArgs = PostCommentFindFirstArgsBase
  ...
  export type PostAttachmentInclude = {
    post?: boolean | PostArgs
  } 

  export type PostAttachmentGetPayload<S extends boolean | null | undefined | PostAttachmentArgs, U = keyof S> =
    S extends { select: any, include: any } ? 'Please either choose `select` or `include`' :
    ...
    : S extends { select: any } & (PostAttachmentArgs | PostAttachmentFindManyArgs)
      ? {
    [P in TrueKeys<S['select']>]:
        P extends 'post' ? PostGetPayload<Exclude<S['select'], undefined | null>[P]> :  P extends keyof PostAttachment ? PostAttachment[P] : never
  } 
      : PostAttachment
  ...
  export interface PostAttachmentDelegate<GlobalRejectSettings extends Prisma.RejectOnNotFound | Prisma.RejectPerOperation | false | undefined> {
    ...
    **/
    ...
    /**
     * Find one PostAttachment that matches the filter or throw
     * `NotFoundError` if no matches were found.
  ...
  export type PostAttachmentFindUniqueArgsBase = {
    ...
    **/
     ...
     * 
    **/
    include?: PostAttachmentInclude | null
    /**
   ...
   */
  export type PostAttachmentFindUniqueOrThrowArgs = PostAttachmentFindUniqueArgsBase
      

  /**
   * PostAttachment: findFirstOrThrow
   */
  export type PostAttachmentFindFirstOrThrowArgs = PostAttachmentFindFirstArgsBase
  ...
  export type FriendshipGetPayload<S extends boolean | null | undefined | FriendshipArgs, U = keyof S> =
    ...
    ? Friendship  & {
    [P in TrueKeys<S['include']>]:
        P extends 'from' ? UserGetPayload<Exclude<S['include'], undefined | null>[P]> :
        P extends 'to' ? UserGetPayload<Exclude<S['include'], undefined | null>[P]> :
        P extends 'notification' ? Array < NotificationGetPayload<Exclude<S['include'], undefined | null>[P]>>  :
        P extends '_count' ? FriendshipCountOutputTypeGetPayload<Exclude<S['include'], undefined | null>[P]> :  never
  } 
    : S extends { select: any } & (FriendshipArgs | FriendshipFindManyArgs)
      ? {
    [P in TrueKeys<S['select']>]:
        P extends 'from' ? UserGetPayload<Exclude<S['select'], undefined | null>[P]> :
        P extends 'to' ? UserGetPayload<Exclude<S['select'], undefined | null>[P]> :
        P extends 'notification' ? Array < NotificationGetPayload<Exclude<S['select'], undefined | null>[P]>>  :
        P extends '_count' ? FriendshipCountOutputTypeGetPayload<Exclude<S['select'], undefined | null>[P]> :  P extends keyof Friendship ? Friendship[P] : never
  } 
      : Friendship
  ...
  export type ConversationGetPayload<S extends boolean | null | undefined | ConversationArgs, U = keyof S> =
    ...
    [P in TrueKeys<S['include']>]:
        P extends 'from' ? UserGetPayload<Exclude<S['include'], undefined | null>[P]> :
        P extends 'to' ? UserGetPayload<Exclude<S['include'], undefined | null>[P]> | null :
        P extends 'messages' ? Array < ConversationMessageGetPayload<Exclude<S['include'], undefined | null>[P]>>  :
    ...
    [P in TrueKeys<S['select']>]:
        P extends 'from' ? UserGetPayload<Exclude<S['select'], undefined | null>[P]> :
        P extends 'to' ? UserGetPayload<Exclude<S['select'], undefined | null>[P]> | null :
        P extends 'messages' ? Array < ConversationMessageGetPayload<Exclude<S['select'], undefined | null>[P]>>  :
  ...
  export type ConversationMessageGetPayload<S extends boolean | null | undefined | ConversationMessageArgs, U = keyof S> =
    S extends { select: any, include: any } ? 'Please either choose `select` or `include`' :
    ...
    [P in TrueKeys<S['include']>]:
        ...
        P extends 'from' ? UserGetPayload<Exclude<S['include'], undefined | null>[P]> :
        P extends 'notification' ? Array < NotificationGetPayload<Exclude<S['include'], undefined | null>[P]>>  :
        P extends '_count' ? ConversationMessageCountOutputTypeGetPayload<Exclude<S['include'], undefined | null>[P]> :  never
  } 
    ...
    [P in TrueKeys<S['select']>]:
        ...
        P extends 'from' ? UserGetPayload<Exclude<S['select'], undefined | null>[P]> :
        P extends 'notification' ? Array < NotificationGetPayload<Exclude<S['select'], undefined | null>[P]>>  :
        P extends '_count' ? ConversationMessageCountOutputTypeGetPayload<Exclude<S['select'], undefined | null>[P]> :  P extends keyof ConversationMessage ? ConversationMessage[P] : never
  } 
      : ConversationMessage
  ...
  export interface ConversationMessageDelegate<GlobalRejectSettings extends Prisma.RejectOnNotFound | Prisma.RejectPerOperation | false | undefined> {
    ...
    **/
    ...
    /**
     * Find one ConversationMessage that matches the filter or throw
     * `NotFoundError` if no matches were found.
   ...
   */
  export type ConversationMessageFindUniqueOrThrowArgs = ConversationMessageFindUniqueArgsBase
      

  /**
   * ConversationMessage: findFirstOrThrow
   */
  export type ConversationMessageFindFirstOrThrowArgs = ConversationMessageFindFirstArgsBase
  ...
  export type NotificationGetPayload<S extends boolean | null | undefined | NotificationArgs, U = keyof S> =
    ...
    ? Notification  & {
    [P in TrueKeys<S['include']>]:
        P extends 'friendship' ? FriendshipGetPayload<Exclude<S['include'], undefined | null>[P]> | null :
        P extends 'message' ? ConversationMessageGetPayload<Exclude<S['include'], undefined | null>[P]> | null :  never
  } 
    : S extends { select: any } & (NotificationArgs | NotificationFindManyArgs)
      ? {
    [P in TrueKeys<S['select']>]:
        P extends 'friendship' ? FriendshipGetPayload<Exclude<S['select'], undefined | null>[P]> | null :
        P extends 'message' ? ConversationMessageGetPayload<Exclude<S['select'], undefined | null>[P]> | null :  P extends keyof Notification ? Notification[P] : never
  } 
      : Notification
  ...
  export type UserWhereInput = {
    ...
    avatarS3Key?: StringNullableFilter | string | null
    coverPicS3Key?: StringNullableFilter | string | null
  ...
  export type UserScalarWhereWithAggregatesInput = {
    ...
    avatarS3Key?: StringNullableWithAggregatesFilter | string | null
    coverPicS3Key?: StringNullableWithAggregatesFilter | string | null
  ...
  export type PostWhereInput = {
    ...
    postAttachments?: PostAttachmentListRelationFilter
  }
  ...
  export type PostOrderByWithRelationInput = {
    ...
    postAttachments?: PostAttachmentOrderByRelationAggregateInput
  }
  ...
  export type UserUpdateInput = {
    ...
    avatarS3Key?: NullableStringFieldUpdateOperationsInput | string | null
    coverPicS3Key?: NullableStringFieldUpdateOperationsInput | string | null
  ...
  export type PostCreateInput = {
    ...
    postAttachments?: PostAttachmentCreateNestedManyWithoutPostInput
  }
  ...
  export type PostUncheckedCreateInput = {
    ...
    postAttachments?: PostAttachmentUncheckedCreateNestedManyWithoutPostInput
  }
  ...
  export type PostUpdateInput = {
    ...
    postAttachments?: PostAttachmentUpdateManyWithoutPostNestedInput
  }
  ...
  export type PostUncheckedUpdateInput = {
    ...
    postAttachments?: PostAttachmentUncheckedUpdateManyWithoutPostNestedInput
  }
  ...
  export type PostAttachmentCreateInput = {
    post: PostCreateNestedOneWithoutPostAttachmentsInput
    type: DocumentType
    s3Key: string
  }
  ...
  export type PostAttachmentUpdateInput = {
    post?: PostUpdateOneRequiredWithoutPostAttachmentsNestedInput
  ...
  export type PostAttachmentCreateNestedManyWithoutPostInput = {
    create?: XOR<Enumerable<PostAttachmentCreateWithoutPostInput>, Enumerable<PostAttachmentUncheckedCreateWithoutPostInput>>
    connectOrCreate?: Enumerable<PostAttachmentCreateOrConnectWithoutPostInput>
    createMany?: PostAttachmentCreateManyPostInputEnvelope
    connect?: Enumerable<PostAttachmentWhereUniqueInput>
  }
  ...
  export type PostAttachmentUpdateManyWithoutPostNestedInput = {
    create?: XOR<Enumerable<PostAttachmentCreateWithoutPostInput>, Enumerable<PostAttachmentUncheckedCreateWithoutPostInput>>
    connectOrCreate?: Enumerable<PostAttachmentCreateOrConnectWithoutPostInput>
    upsert?: Enumerable<PostAttachmentUpsertWithWhereUniqueWithoutPostInput>
    createMany?: PostAttachmentCreateManyPostInputEnvelope
    set?: Enumerable<PostAttachmentWhereUniqueInput>
    disconnect?: Enumerable<PostAttachmentWhereUniqueInput>
    delete?: Enumerable<PostAttachmentWhereUniqueInput>
    connect?: Enumerable<PostAttachmentWhereUniqueInput>
    update?: Enumerable<PostAttachmentUpdateWithWhereUniqueWithoutPostInput>
    updateMany?: Enumerable<PostAttachmentUpdateManyWithWhereWithoutPostInput>
    deleteMany?: Enumerable<PostAttachmentScalarWhereInput>
  }
  ...
  export type PostCreateNestedOneWithoutPostAttachmentsInput = {
    create?: XOR<PostCreateWithoutPostAttachmentsInput, PostUncheckedCreateWithoutPostAttachmentsInput>
    connectOrCreate?: PostCreateOrConnectWithoutPostAttachmentsInput
    connect?: PostWhereUniqueInput
  }

  export type PostUpdateOneRequiredWithoutPostAttachmentsNestedInput = {
    create?: XOR<PostCreateWithoutPostAttachmentsInput, PostUncheckedCreateWithoutPostAttachmentsInput>
    connectOrCreate?: PostCreateOrConnectWithoutPostAttachmentsInput
    upsert?: PostUpsertWithoutPostAttachmentsInput
    connect?: PostWhereUniqueInput
    update?: XOR<PostUpdateWithoutPostAttachmentsInput, PostUncheckedUpdateWithoutPostAttachmentsInput>
  }
  ...
  export type PostAttachmentCreateManyPostInputEnvelope = {
    data: Enumerable<PostAttachmentCreateManyPostInput>
    skipDuplicates?: boolean
  }
  ...
  export type PostAttachmentUpdateManyWithWhereWithoutPostInput = {
    ...
    data: XOR<PostAttachmentUpdateManyMutationInput, PostAttachmentUncheckedUpdateManyWithoutPostAttachmentsInput>
  }

  export type PostAttachmentScalarWhereInput = {
    AND?: Enumerable<PostAttachmentScalarWhereInput>
    OR?: Enumerable<PostAttachmentScalarWhereInput>
    NOT?: Enumerable<PostAttachmentScalarWhereInput>
    id?: IntFilter | number
    postId?: IntFilter | number
    type?: EnumDocumentTypeFilter | DocumentType
    s3Key?: StringFilter | string
  ...
  export type PostCreateWithoutPostAttachmentsInput = {
    createdAt?: Date | string
    updatedAt?: Date | string
    htmlContent: string
    user: UserCreateNestedOneWithoutPostsInput
  ...
  export type PostUncheckedCreateWithoutPostAttachmentsInput = {
    id?: number
    createdAt?: Date | string
    updatedAt?: Date | string
    htmlContent: string
  ...
  export type PostCreateOrConnectWithoutPostAttachmentsInput = {
    where: PostWhereUniqueInput
    create: XOR<PostCreateWithoutPostAttachmentsInput, PostUncheckedCreateWithoutPostAttachmentsInput>
  }

  export type PostUpsertWithoutPostAttachmentsInput = {
    update: XOR<PostUpdateWithoutPostAttachmentsInput, PostUncheckedUpdateWithoutPostAttachmentsInput>
    create: XOR<PostCreateWithoutPostAttachmentsInput, PostUncheckedCreateWithoutPostAttachmentsInput>
  }

  export type PostUpdateWithoutPostAttachmentsInput = {
    createdAt?: DateTimeFieldUpdateOperationsInput | Date | string
    updatedAt?: DateTimeFieldUpdateOperationsInput | Date | string
    htmlContent?: StringFieldUpdateOperationsInput | string
    user?: UserUpdateOneRequiredWithoutPostsNestedInput
  ...
  export type PostUncheckedUpdateWithoutPostAttachmentsInput = {
    id?: IntFieldUpdateOperationsInput | number
    createdAt?: DateTimeFieldUpdateOperationsInput | Date | string
    updatedAt?: DateTimeFieldUpdateOperationsInput | Date | string
    htmlContent?: StringFieldUpdateOperationsInput | string
  ...
  export type PostAttachmentUncheckedUpdateManyWithoutPostAttachmentsInput = {
    id?: IntFieldUpdateOperationsInput | number
    type?: EnumDocumentTypeFieldUpdateOperationsInput | DocumentType
    s3Key?: StringFieldUpdateOperationsInput | string
  }
